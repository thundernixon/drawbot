...
for frame in range(frames):
    ...
    print(messageLength)
    bez = BezierPath()
    bez.text(message, font="IBMPlexMono-Bold", fontSize=resolution*0.75, offset=(resolution-posX*messageLength/2.6,1.75)) #offset=(20-posX,1)
...
saveImage("exports/welcome-font-nerds-4.gif")