...
frames = 70 # currently must be lower than number of maxSpokes
rotations = 1
totalSize = 1000

maxSpokes = 500 # currently must be higher than number of frames
minSpokes = 40
spokes = minSpokes
distance = 0
maxDistance = 1000
...
incrRadius = ((totalSize-starterRadius)/frames)*-2.5
...
saveImage("exports/moire_27-110717.gif")
